...
void cargarDatos()
{
    ...
    DTProducto dataPR4 = DTProducto(4, 15, 1999.99, "Microondas Digital", "Microondas digital, 30L", "E");
    ...
    DTProducto dataPR8 = DTProducto(8, 10, 15499.99, "Refrigerador", "Refrigerador de doble puerta", "E");
    DTProducto dataPR9 = DTProducto(9, 50, 2500, "Cafetera", "Cafetera de goteo programable", "E");
    DTProducto dataPR10 = DTProducto(10, 20, 5000, "Zapatillas Deportivas", "Zapatillas para correr, talla 42", "R");
    DTProducto dataPR11 = DTProducto(11, 25, 699.99, "Mochila", "Mochila de viaje, 40L", "O");
